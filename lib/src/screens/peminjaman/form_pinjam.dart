...
//     // var data = await getGroupUser();
//     // setState(() {
//     //   groupUserList = List<Map<String, String>>.from(data.map((item) => {
//     //     'id_group_user': item['id_group_user'].toString(),
//     //     'nama_group_user': item['nama_group_user'].toString(),
//     //   }));
//     // });
//     await Future.delayed(Duration(seconds: 1));
//     setState(() {
//       groupUserList = ['Individu', 'BEM', 'KSM', 'HIMA', 'Lainnya'];
//     });
//   }
//
